...
public class VentaService : IVentaService
{
    ...
    private ILogger<VentaService> _logger;
    private readonly IOptions<AppConfig> _options;


    public VentaService(IVentaRepository repository, IMapper mapper, ILogger<VentaService> logger, IOptions<AppConfig> options)
    {
    ...
    public async Task<BaseResponseGeneric<int>> AddAsync(FacturaDTO identity)
    {
        ...
        try
        {
            ...
            _logger.LogInformation($"Venta realizada con exito");
            return response;
        }
        catch (Exception ex)
        {
